  ...
  return (
    <div>
      <div className="bg-gradient-to-t from-marine-600 to-marine-500 px-6 py-5 flex flex-col gap-8">
        <img
          src="https://github.com/davicecilio.png"
          alt="Logo"
      ...
      <main className="p-6 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-5 py-5 px-5 rounded-lg border-mirage-100 shadow-lg">
          ...
          <div className="flex items-center justify-between">
            <a
              href="#"
              className="py-3 px-4 flex items-center gap-3 font-bold text-sm bg-marine-500 hover:bg-marine-600 text-mirage-50 rounded-md"
            >
              Acessar coleções
